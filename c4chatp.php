...
<style>
 body{
        ...
        background-image: url("https://d.top4top.io/p_1561sn82x9.jpg");
      }
body *{
    transition:0.2 ease;
  ...
  <body>
      ...
      <div class="form">
        <!-- the input -->
      <div class="first-row">
        <a href="#"><img src=https://a.top4top.io/p_1561d7bn09.png" alt="login" class="icon-login"></a>
        <h2 class="first-login"><b> مرحبا </b> في موقع لاضافه نقاط مجانيه في <br />شات بلس </h2>
      </div>
        ...
        <div class="row">
          <div class="remember-me col-sm-6 col-xs-6">
            ...
            <p>get comments</p>
 <input type="text" class="form-control" placeholder="عدد النقاط :">
          </div>
          <div class="row">
          <div class="remember-me col-sm-6 col-xs-6">
            <label class="switch">
...
<div class="row">
   ...
   <div class="social-login col-sm-6 col-sm-offset-3">    
      <p class="sign-up"><u>Not A Member</u>? <a href="https://instagram.com/signup"><code>SIGN UP Now!</code></a></p>   </div>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
  </body>
</html>
<script>
alert('ملاحظه يتم ارسال النقاط عن طريق المعرف المصنوع بواسطه المارشنت او بتاريخ 2020-1-1 لاستلام النقاط تحياتي دِيَــــــــــ♢ـــــــٱآڕ♡بْــٱشُــــــ♢ـــــــآ');
</script>
